...
describe('Validator: url', function() {
  ...
  describe('Valid URLs', function() {
    ...
    it('should accept HTTPS URL', async function() {
      ...
      const result = await compiled._validateValue('https://example.com');
    ...
    it('should accept URL with path', async function() {
      ...
      const result = await compiled._validateValue('https://example.com/path/to/page');
    ...
    it('should accept URL with query string', async function() {
      ...
      const result = await compiled._validateValue('https://example.com?foo=bar');
    ...
    it('should accept URL with hash', async function() {
      ...
      const result = await compiled._validateValue('https://example.com#section');
    ...
    it('should accept URL with port', async function() {
      ...
      const result = await compiled._validateValue('https://example.com:8080/path');
    ...
    it('should accept file protocol URL', async function() {
      ...
      const result = await compiled._validateValue('file:///path/to/file');
    ...
    it('should accept FTP URL', async function() {
      ...
      const result = await compiled._validateValue('ftp://ftp.example.com/file.txt');
  ...
  describe('Invalid URLs', function() {
    ...
    it('should accept valid URL with special characters', async function() {
      ...
      const result = await compiled._validateValue('http://example.com/path?query=value');
  ...
  describe('URL normalization', function() {
    ...
    it('should preserve existing path', async function() {
      ...
      const result = await compiled._validateValue('http://example.com/page');
