...
describe('Processor: port', function() {
  /** @type {SchemaResolver} */
  let resolver;
  ...
  it('should accept valid port numbers and return number', async function() {
    const schema = new Schema('number').validator('$port');
  ...
  it('should accept valid port strings and return strings for string schemas', async function() {
