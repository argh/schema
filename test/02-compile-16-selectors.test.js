...
describe('Schema Compilation - Selectors and Selections', function() {
  ...
  describe('Selection conditions', function() {
    ...
    it('should auto-generate condition for selection properties', async function() {
      ...
      const result = await compiled.properties.option1.checkCondition({});
    ...
    it('should condition return true when selector matches implicit selection', async function() {
      ...
      const result = await compiled.properties.storage.checkCondition({}, config, new SchemaLocation(compiled).relative('storage'));
    ...
    it('should condition return false when selector does not match implicit selection', async function() {
      ...
      const result = await compiled.properties.storage.checkCondition({}, config);
    ...
    it('should condition return true when selector matches explicit selection', async function() {
      ...
      const result = await compiled.properties.debug.checkCondition({}, config, new SchemaLocation(compiled).relative('debug'));
    ...
    it('should condition return false when selector does not match explicit selection', async function() {
      ...
      const result = await compiled.properties.debug.checkCondition({}, config);
    ...
    it('should condition return false when selector is not set', async function() {
      ...
      const config = {};
      const result = await compiled.properties.option.checkCondition({}, config);
  ...
  describe('Nested selectors', function() {
    ...
    it('should check nested selection condition correctly', async function() {
      ...
      const storageResult = await compiled.properties.storage.checkCondition({}, storageConfig, new SchemaLocation(compiled).relative('storage'));
      ...
      const uploadResult = await compiled.properties.storage.properties.upload.checkCondition({}, uploadConfig, new SchemaLocation(compiled).relative('storage.upload'));
  ...
  describe('Multiple selections with same value', function() {
    ...
    it('should enable all selections with same value when selector matches', async function() {
      ...
      const result1 = await compiled.properties.feature1.checkCondition({}, config, new SchemaLocation(compiled).relative('feature1'));
      assert.strictEqual(result1, true);

      const result2 = await compiled.properties.feature2.checkCondition({}, config, new SchemaLocation(compiled).relative('feature2'));
