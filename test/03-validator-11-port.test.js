...
describe('Validator: port', function() {
  ...
  it('should accept valid port numbers and return number', async function() {
    ...
    const result = await compiled._validateValue('8080');
  ...
  it('should accept port 1', async function() {
    ...
    const result = await compiled._validateValue('1');
  ...
  it('should accept port 65535', async function() {
    ...
    const result = await compiled._validateValue('65535');
  ...
  it('should accept common ports', async function() {
    ...
    await compiled._validateValue('80'); // HTTP
    await compiled._validateValue('443'); // HTTPS
    await compiled._validateValue('22'); // SSH
    await compiled._validateValue('3306'); // MySQL
  });
  ...
  it('should reject port above 65535', async function() {
    ...
    await assert.rejects(() => compiled._validateValue('65536'), ValidationError);
  });
  ...
  it('should reject decimal port', async function() {
    ...
    await assert.rejects(() => compiled._validateValue('80.5'), ValidationError);
  });
  ...
  it('should reject non-numeric port', async function() {
    ...
    await assert.rejects(() => compiled._validateValue('http'), ValidationError);
  });
});