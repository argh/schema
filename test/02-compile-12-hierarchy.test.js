...
describe('Schema Compilation - Hierarchy', function() {
  ...
  describe('Nested object properties', function() {
    ...
    it('should compile two-level nested objects', function() {
    ...
    it('should compile three-level nested objects', function() {
      const schema = new Schema('object')
    ...
    it('should compile deeply nested hierarchy', function() {
      const schema = new Schema('object')
      ...
      assert.strictEqual(typeof deep.normalize, 'function');
    });
  });

  describe('Path construction in hierarchy', function() {

    it('should build correct paths through hierarchy', function() {
      const schema = new Schema('object')
        .property('user', new Schema('object')
    ...
    it('should build paths with array indices', function() {
      const schema = new Schema('object')
  ...
  describe('Parent chain traversal', function() {
    ...
    it('should maintain parent chain through nested objects', function() {
      const schema = new Schema('object')
    ...
    it('should track names through parent chain', function() {
      const schema = new Schema('object')
  ...
  describe('Arrays with element schemas', function() {
    ...
    it('should compile array with nested object elements', function() {
    ...
    it('should compile array with nested array elements', function() {
      const schema = new Schema('array')
    ...
    it('should compile tuple with different nested structures', function() {
      const schema = new Schema('array')
        .property('0', new Schema('object')
          .property('name', new Schema('string')))
  ...
  describe('Mixed object and array hierarchies', function() {
    ...
    it('should compile object containing array containing object', function() {
      const schema = new Schema('object')
    ...
    it('should compile array containing object containing array', function() {
      const schema = new Schema('array')
        .property('*', new Schema('object')
    ...
    it('should compile complex nested structure', function() {
      const schema = new Schema('object')
        .property('users', new Schema('array')
          .property('*', new Schema('object')
            .property('name', new Schema('string'))
  ...
  describe('Property resolution through hierarchy', function() {
    ...
    it('should resolve properties at each level', function() {
      const schema = new Schema('object')
    ...
    it('should independently compile schemas at each level', function() {
      const schema = new Schema('object')
  ...
  describe('Wildcard hierarchies', function() {
    ...
    it('should handle wildcards at multiple levels', function() {
      const schema = new Schema('object')
        .property('*', new Schema('object')
          .property('*', new Schema('string')));
    ...
    it('should mix named and wildcard at different levels', function() {
      const schema = new Schema('object')
        .property('config', new Schema('object')
          .property('*', new Schema('string')))
        .property('*', new Schema('number'));
      ...
      assert.strictEqual(typeof configValue.normalize, 'function');
  ...
  describe('find() method for path resolution', function() {
    ...
    it('should find schema at simple path', function() {
      const schema = new Schema('object')
        .property('name', new Schema('string'));
    ...
    it('should find schema at nested path', function() {
      const schema = new Schema('object')
        .property('user', new Schema('object')
          .property('profile', new Schema('object')
    ...
    it('should return self for empty path', function() {
      const schema = new Schema('object');
      const compiled = resolver.compile(schema);
    ...
    it('should return self for dot path', function() {
      const schema = new Schema('object');
      const compiled = resolver.compile(schema);
    ...
    it('should find through array indices', function() {
      const schema = new Schema('object')
        .property('items', new Schema('array')
  ...
  describe('Compilation with deep type variety', function() {
    ...
    it('should compile hierarchy with all base types', function() {
      const schema = new Schema('object')
    ...
    it('should properly inherit base type behaviors at all levels', function() {
      const schema = new Schema('object')
        .property('level1', new Schema('object')
      ...
      assert.strictEqual(stringVal.normalize(123), '123');
      assert.strictEqual(numberVal.normalize('456'), 456);
      assert.strictEqual(boolVal.normalize('yes'), true);
    });
  });

  describe('Hierarchy immutability', function() {

    it('should freeze all levels of hierarchy', function() {
      const schema = new Schema('object')
        .property('a', new Schema('object')
          .property('b', new Schema('object')
            .property('c', new Schema('string'))));
    ...
    it('should freeze properties at all levels', function() {
      const schema = new Schema('object')
        .property('outer', new Schema('object')
          .property('inner', new Schema('string')));
  ...
  describe('Real-world hierarchy examples', function() {
    ...
    it('should compile typical API response schema', function() {
      const schema = new Schema('object')
    ...
    it('should compile configuration file schema', function() {
      const schema = new Schema('object')
        .property('server', new Schema('object')
          .property('host', new Schema('string').default('localhost'))
